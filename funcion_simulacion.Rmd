...
ns <- seq(10,)
n <- 50
n_sim <- OK_IDW_n_values(n=n,contorno=contorno,datos_t=datos_t,datos_tt=datos_tt,vbin.fit=vbin.fit)

g <- future_replicate(10, expr = mse_ok_idw(mu_sigma=n_sim$matrix,grid=n_sim$ubi))
